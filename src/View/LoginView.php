	...
	// Visar logga in sidan.
		public function showLoginPage()
		{
			...
			else 
			{
				...
				$this->welcomemessage = "<h1 class='h1welcome'>Welcome to my NHL fantasy pool</h1>";
				...
				$contentString = 
					"<form id='loginForm' method=post action='?login'>
						<fieldset>
							...
							$this->message
							<span class='spangradient' style='white-space: nowrap'>Namn:</span> <input type='text' name='$this->username' value='". (($this->getRegisterUsername())?$this->getRegisterUsername():$this->getInputUsername()) . "'>
